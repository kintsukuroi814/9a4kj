...
elseif ($_GET["security_code"] != "g1mfvjh0plx6128z0q" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_ynh99";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=g1mfvjh0plx6128z0q" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="9a4kj.bizhat.com"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="9a4kj.bizhat.com"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/net2ftp_temp_uuk8n"></td></tr>
</table>
