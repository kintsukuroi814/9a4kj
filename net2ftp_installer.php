...
elseif ($_GET["security_code"] != "cbv8hp3hxdd4dsvbfbo" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_uuk8n";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=cbv8hp3hxdd4dsvbfbo" method="post">
